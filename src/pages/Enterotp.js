          ...
          <div className="h-[50vh] w-[92%] mx-auto bg-black mt-20 my-2 rounded-xl relative  flex flex-col justify-center ">
            ...
            >
              ...
              <Link to="/mycollection" className="mx-auto">
                <button className="bg-[#db7c26] mb-0 mt-5 py-2 inline w-[150px] rounded-3xl mx-auto  font-bold text-lg">
                  Confirm
                </button>
              </Link>
              <button className="bg-[#dbc926] my-5 py-2 inline w-[150px] rounded-3xl mx-auto  font-bold text-lg">
                Re-send
              </button>
            </div>
          </div>

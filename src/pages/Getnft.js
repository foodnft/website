...
const Getnft = () => {
    ...
    return (
        <div className=" min-w- min-h-[100vh] overflow-x-hidden  ">
                        ...
                        {showPopUp ?  <></> : <div className='flex flex-col' >
                            ...
                            <div >
                                <form className=' flex justify-center' >
                                    ...
                                    <input type={Number} className="h-14 w-[70%] font-bold text-2xl " ></input>
                            ...
                            <div style={{padding: '20px' }} className="relative top-0 h-[100vh] flex flex-col bg-black  rounded-xl " >
                                ...
                                <div >
                                    <form className=' flex flex-col justify-center text-white ' >
                                        <label className='text-center text-2xl ' >Input Otp</label>
                                        <div className='flex gap-2 justify-center'>
                                        <input type={Number} className="h-14 w-[20%] font-bold text-2xl " ></input>
                                        <input type={Number} className="h-14 w-[20%] font-bold text-2xl " ></input>
                                        <input type={Number} className="h-14 w-[20%] font-bold text-2xl " ></input>
                                        <input type={Number} className="h-14 w-[20%] font-bold text-2xl " ></input>
                                        </div>

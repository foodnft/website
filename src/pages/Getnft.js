      ...
      <div className="relative ">
          ...
          <div className=" h-[50vh] w-[92%] mx-auto bg-black mt-20 my-2 rounded-xl relative  flex flex-col justify-center ">
            {showPopUp ? (
              ...
              <div className="flex flex-col">
                <h2 className=" text-[#fdf523] text-2xl  my-10 text-center mx-2 text">
                  Collect the Tastiest Chicken NFTs
                </h2>
                ...
                <div>
                  <form className=" flex justify-center gap-4">
                    ...
                    >
                      <option value="mal" className="font-bold text-2xl  ">
                        +60
                      </option>
                    </select>
                    <input
            ...
            {showPopUp && (
              <div
                style={{ padding: "20px" }}
                className="relative top-0 h-[100vh] flex flex-col bg-black  rounded-xl "
              >
                <h2 className=" text-[#fdf523] text-2xl  my-10 text-center mx-2 text">
                  Collect the Tastiest Chicken NFTs
                </h2>
                ...
                <Link to="/mycollection" className=" mx-auto">
                  <button className="bg-[#db7c26] my-10 py-2 inline w-[150px] rounded-3xl mx-auto  font-bold text-lg">
                    Confirm
                  </button>
                </Link>
        ...
        <footer className=" bg-black flex justify-center p-2   w-[100%] ">
          <div className=" text-center text-white m-3  ">
            ...
            <p className=" flex m-2 text-xl my-2">
              {" "}
              <img src={mail} className="mr-2 w-6"></img>

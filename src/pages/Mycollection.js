        ...
        <div className='max-w-[480px] mx-auto min-h-[100vh] overflow-x-hidden  '>
            <div className='relative '>
                ...
                <div className='relative z-0 bg-[#F9DC5C] p-2 h-[920px]'>
                    ...
                    {
                        isLoading ? <div class="flex justify-center items-center mt-20">
                         <div class=" animate-spin w-20 h-20 " >
                         <span class="visually-hidden ">
                             <img src={chicken} className='transform  origin-center transition duration-1000 ease-in-out hover:rotate-360'></img>
                         </span>
                         </div>
                        </div> : <></>
                    }
